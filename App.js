...
import ListaPacotes  from './paginas/pacotes/lista'
import DetalhesPacotes  from './paginas/pacotes/detalhes'
...
const Pacotes = () => {
  return(
    <Stack.Navigator initialRouteName="ListaPacotes">
        ...
        <Stack.Screen name="DetalhesPacote" component={DetalhesPacotes} />
    </Stack.Navigator>
  )
}
